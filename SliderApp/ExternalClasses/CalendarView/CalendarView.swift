...
let calendarCellReuseIdentifier = "CalendarDayCell"
...
class CalendarView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    fileprivate func createSubviews() {
        ...
        // Register Class
        self.calendarView.register(CalendarDayCell.self, forCellWithReuseIdentifier: calendarCellReuseIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let dayCell = collectionView.dequeueReusableCell(withReuseIdentifier: calendarCellReuseIdentifier, for: indexPath) as! CalendarDayCell
